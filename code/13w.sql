...
create table classes(
    ...
    class_id int primary key, --자동인덱스
...
create table members2(
    member_id SERIAL int primary key,
    name varchar(30) not null,
    phone varchar(13),
    join_date date;
);
...
--검색 시간 확인하기
explain analyze
select * from members2 where name = '홍길동';
-- Planing time: 0.052 ms
-- Execution time: 11.852 ms

--index 추가
create index idx_members_name2
on members2(name);
-- Planing time: 0.052 ms => 1.025 ms
-- Execution time: 11.852 ms => 0.071 ms
